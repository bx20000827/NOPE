...
3. If you wish to conduct the GNN-based node classification experiment, please execute the data_con.py + gnn_model.py files in the gnn_node_classification folder.
